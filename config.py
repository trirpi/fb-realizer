...
pieces = {
    ...
    "JPassion": {"path": "BWV_245_passion.musicxml", "time_signatures": [TimeSignature("3/4", offset=0)]},
    "TrioCouperin": {"path": "Couperin_Trio_Sonata.musicxml", "time_signatures": [TimeSignature("6/4", offset=43*4)]},
}
